      ...
      {choices.map((choice, index) => {
        ...
        return (
          <button
            ...
            className="sticker shop-choice animate-pop-in flex min-h-[88px] flex-col items-center justify-center gap-1 p-2 sm:min-h-[104px] sm:p-3"
            style={{ animationDelay: `${Math.min(index * 28, 320)}ms` }}
          >
            <span className="shop-choice-art pointer-events-none block w-14 drop-shadow-[0_3px_2px_rgba(74,44,42,0.22)] sm:w-16">{choice.art}</span>
